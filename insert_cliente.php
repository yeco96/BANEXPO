            ...
            $cnx_mysql = mysql_connect("localhost","root","negro");
            mysql_select_db("banexpomysql",$cnx_mysql);
          
            
            
            
            if ($_POST['selectsucursal'] == 1) {
            if ($_POST) {
            ...
            $result = pg_query($cnx, "INSERT INTO clientesj (cedula, nombre, codsucursal) VALUES (" .$cedula. " , '" .$nombre. " ' , " . $sucursal. " );") or die(pg_last_error());
            
            $q = mysql_query("INSERT INTO clientesj
            (`cedula`,
            `nombre`,
            `codsucursal`)
            VALUES
            ...
            if ($_POST['selectsucursal'] == 2) {
            if ($_POST) {
            $cedula = $_POST['txtcedula'];
            $nombre = $_POST['txtnombre'];
            $sucursal = $_POST['selectsucursal'];
            
            $q = mysql_query("INSERT INTO clientelb
            (`cedula`,
            `nombre`,
            `codsucursal`)
            VALUES
            ...
            $result = pg_query($cnx, "INSERT INTO clientelb (cedula, nombre, codsucursal) VALUES (" .$cedula. " , '" .$nombre. " ' , " . $sucursal. " );") or die(pg_last_error());
            if (!$result) {
            echo "Query: Un error ha occurido.\n";
            exit;
            }
            ...
            if($_POST['selectsucursal'] == 3){
            if ($_POST) {
            $cedula = $_POST['txtcedula'];
            $nombre = $_POST['txtnombre'];
            $sucursal = $_POST['selectsucursal'];
            
            $q = mysql_query("INSERT INTO clientepz
            (`cedula`,
            `nombre`,
            `codsucursal`)
            VALUES
            ...
            $result = pg_query($cnx, "INSERT INTO clientepz (cedula, nombre, codsucursal) VALUES (" .$cedula. " , '" .$nombre. " ' , " . $sucursal. " );") or die(pg_last_error());
            if (!$result) {
            echo "Query: Un error ha occurido.\n";
            exit;
            }
